class Opponent {
  ...
  againDraw() {
    ...
    this.body[6] = createVector(270, 210);
    this.body[7] = createVector(280, 220);
    this.body[8] = createVector(285, 225);
    this.wheel[8] = createVector(265, 215);
    this.wheel[9] = createVector(265, 255);
    this.wheel[10] = createVector(315, 215);
    this.wheel[11] = createVector(315, 255);
    ...
    this.body[21] = createVector(160, 50);
    this.body[22] = createVector(170, 60);
    this.body[23] = createVector(175, 65);
    this.wheel[28] = createVector(155, 55);
    this.wheel[29] = createVector(155, 95);
    this.wheel[30] = createVector(205, 55);
    this.wheel[31] = createVector(205, 95);
  ...
  easyMode() {
    if (this.body[3].y == 672 || this.body[3].y == 677) {
      this.r = random(0, 255);
      this.g = random(0, 255);
      this.b = random(0, 255);
    ...
    if (this.body[6].y == 671 || this.body[6].y == 677) {
      this.r2 = random(0, 255);
      this.g2 = random(0, 255);
      this.b2 = random(0, 255);
    ...
    if (this.body[9].y == 676 || this.body[9].y == 677) {
      this.r3 = random(0, 255);
      this.g3 = random(0, 255);
      this.b3 = random(0, 255);
    ...
    if (this.body[12].y == 672 || this.body[12].y == 677) {
      this.r4 = random(0, 255);
      this.g4 = random(0, 255);
      this.b4 = random(0, 255);
    ...
    if (this.body[15].y == 678 || this.body[15].y == 677) {
      this.r5 = random(0, 255);
      this.g5 = random(0, 255);
      this.b5 = random(0, 255);
    ...
    if (this.body[18].y == 675 || this.body[18].y == 677) {
      this.r6 = random(0, 255);
      this.g6 = random(0, 255);
      this.b6 = random(0, 255);
    ...
    if (this.body[21].y == 678 || this.body[21].y == 677) {
      this.r7 = random(0, 255);
      this.g7 = random(0, 255);
      this.b7 = random(0, 255);
    ...
    if (this.body[24].y == 676 || this.body[24].y == 677) {
      this.r8 = random(0, 255);
      this.g8 = random(0, 255);
      this.b8 = random(0, 255);
  ...
  hardMode() {
    if (this.body[3].y == 678 || this.body[3].y == 674) {
      this.r = random(0, 255);
      this.g = random(0, 255);
      this.b = random(0, 255);
      this.x = random(135, 355 - this.w);
    ...
    if (this.body[9].y == 670 || this.body[9].y == 674) {
      this.r3 = random(0, 255);
      this.g3 = random(0, 255);
      this.b3 = random(0, 255);
      this.x3 = random(364, 710 - this.w);
    ...
    if (this.body[12].y == 678 || this.body[12].y == 674) {
      this.r4 = random(0, 255);
      this.g4 = random(0, 255);
      this.b4 = random(0, 255);
      this.x4 = random(364, 710 - this.w);
    ...
    if (this.body[15].y == 671 || this.body[15].y == 674) {
      this.r5 = random(0, 255);
      this.g5 = random(0, 255);
      this.b5 = random(0, 255);
      this.x5 = random(364, 710 - this.w);
    ...
    if (this.body[18].y == 672 || this.body[18].y == 674) {
      this.r6 = random(0, 255);
      this.g6 = random(0, 255);
      this.b6 = random(0, 255);
      this.x6 = random(364, 710 - this.w);
    ...
    if (this.body[21].y == 678 || this.body[21].y == 674) {
      this.r7 = random(0, 255);
      this.g7 = random(0, 255);
      this.b7 = random(0, 255);
      this.x7 = random(135, 355 - this.w);
    ...
    if (this.body[24].y == 670 || this.body[24].y == 674) {
      this.r8 = random(0, 255);
      this.g8 = random(0, 255);
      this.b8 = random(0, 255);
      this.x8 = random(135, 355 - this.w);
